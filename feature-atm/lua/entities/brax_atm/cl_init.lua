...
-- english translation
language.Add('ATM_Deposit_Ok', 'Депозит')
language.Add('ATM_Deposit_Fail', 'Fail')
language.Add('ATM_Withdraw_Ok', 'Снять')
language.Add('ATM_Withdraw_Fail', 'Fail')
language.Add('ATM_Deposit', 'Депозит')
language.Add('ATM_Withdraw', 'Снять')
language.Add('ATM_Del','←')
language.Add('ATM_Home', 'Назад')
language.Add('ATM_Balance', 'Баланс')
language.Add('ATM_Home1', 'Старобанк ATM')
language.Add('ATM_Home2', 'Лучшиее у нас')
language.Add('ATM_Home3', 'До встречи!')
language.Add('ATM_Return_code','Назад')
language.Add('ATM_Transaction_Success', 'Транзакция успешна')
language.Add('ATM_Transaction_Failed', 'Транзакция неудачна')
