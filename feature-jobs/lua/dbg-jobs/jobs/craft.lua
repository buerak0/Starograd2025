...
local jewelryItems = {
	...
	{ 8000, 'Золотое кольцо с алмазом' },
	{ 7000, 'Золотое кольцо с рубином' },
	{ 6000, 'Золотое кольцо с сапфиром' },
	{ 5500, 'Серебряное кольцо с сапфиром' },
	{ 2000, 'Золотой браслет с рубинами' },
	{ 1000, 'Золотое ожерелье с рубинами' },
	{ 2000, 'Серьги с алмазом и жемчужиной' },
}
