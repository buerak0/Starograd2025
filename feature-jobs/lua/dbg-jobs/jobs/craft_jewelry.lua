...
octoinv.addShopItem('jewelry_pearl', { cat = 'jewelry', price = 450 })
octoinv.addShopItem('jewelry_diamond', { cat = 'jewelry', price = 1500 })
octoinv.addShopItem('jewelry_ruby', { cat = 'jewelry', price = 1100 })
octoinv.addShopItem('jewelry_sapphire', { cat = 'jewelry', price = 500 })
octoinv.addShopItem('jewelry_topaz', { cat = 'jewelry', price = 320 })
octoinv.addShopItem('jewelry_emerald', { cat = 'jewelry', price = 450 })
