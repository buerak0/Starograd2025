...
function octogui.reloadF4()
	...
	function f:Paint(w, h)
		...
		draw.NoTexture()
		surface.SetDrawColor(51, 51, 51, 100 * a)
		...
		-- bottom left
		drawText(
			L.purse_hint .. DarkRP.formatMoney(ply:GetNetVar('money') or 0), 'f4.normal', 10, h - 55,
		...
		local adminCount = CountAdminsOnline()
        drawText(
			"Администраторов: " .. adminCount, 'f4.normal', 10, h - 8,
			TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM, cols.txt, cols.txtSh
		)
