...
for i, v in ipairs({
	...
	{'Форум', function() octoesc.OpenURL('https://discord.gg/v2YDDYkDpy') end},                
    {'Правила', function() octoesc.OpenURL('https://docs.google.com/document/d/1G12Rm-QVNtpbNHOE7_5rQWWLPdOzOKiO_xWYZjEfOh8/edit?tab=t.0#heading=h.muqro4odkwta') end},
	{'Сайт', function() octoesc.OpenURL('https://discord.gg/v2YDDYkDpy') end},
    {'Контент', function() octoesc.OpenURL('https://steamcommunity.com/sharedfiles/filedetails/?id=3370269754') end},          
    {'Обратная Связь', function() octoesc.OpenURL('https://discord.gg/v2YDDYkDpy') end},
	...
	{'Отключиться', function()
		...
		if octoinv and octoinv.invs[eID]._hand and octoinv.invs[eID]._hand.items[1] then
			Derma_Query('вы уверены?', 'Выход с сервера', L.yes, function() RunConsoleCommand('disconnect') end, L.no)
		else
