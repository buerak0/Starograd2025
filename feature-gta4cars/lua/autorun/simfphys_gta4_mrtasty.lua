local V = {
	...
	Category = 'Белогорск - Индустриальные',
	...
	Members = {
        ...
        Dash = { pos = Vector(52.542, 20.688, 35.905), ang = Angle(-0.0, -90.0, 61.9) },
		Radio = { pos = Vector(62.325, -0.008, 20.204), ang = Angle(-24.9, -180.0, -0.0) },
		Plates = {
			Front = { pos = Vector(97.500, -0.010, -4.295), ang = Angle(0.0, 0.0, 0.0) },
			Back = { pos = Vector(-125.513, -0.000, -10.507), ang = Angle(0.0, 180.0, 0.0) },
		},
		Mirrors = {
            top = {
