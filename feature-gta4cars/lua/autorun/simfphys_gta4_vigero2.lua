local V = {
	...
	Members = {
        ...
        Dash = { pos = Vector(12.469, 16.686, 4.903), ang = Angle(-0.0, -90.0, 77.0) },
		Radio = { pos = Vector(17.962, 2.010, 3.947), ang = Angle(-19.6, -180.0, 0.0) },
		Plates = {
			Back = { pos = Vector(-98.164, 0.008, -9.328), ang = Angle(-10.1, 180.0, 0.0) },
		},
		Mirrors = {
			top = {
				pos = Vector(7.675, 0.030, 20.598),
				ang = Angle(10, 0, 0),
				w = 1 / 3,
				ratio = 3.5 / 1,
			},
