local V = {
	...
	Members = {
		...
		Gears = {-0.4,0,0.20,0.35,0.5,0.75,1},

		Dash = { pos = Vector(60.469, 18.686, 20.903), ang = Angle(-0.0, -90.0, 57.0) },
		Radio = { pos = Vector(45.962, 0.010, 15.947), ang = Angle(-20.6, -180.0, 0.0) },
		Plates = {
			Front = { pos = Vector(124.097, -0.016, -5.006), ang = Angle(0.0, 0.0, 0.0) },
			Back = { pos = Vector(-129.964, 0.008, 13.328), ang = Angle(-18.1, 180.0, 0.0) },
		},
		Mirrors = {
			top = {
				pos = Vector(35.675, 0.030, 33.598),
				ang = Angle(10, 0, 0),
				w = 1 / 3,
				ratio = 3.5 / 1,
			},
			left = {
				pos = Vector(30, 40, 20.617),
				w = 1 / 5,
				ratio = 4.5 / 3,
			},
			right = {
				pos = Vector(30, -40, 20.650),
				w = 1 / 5,
				ratio = 4.5 / 3,
			},
		},
