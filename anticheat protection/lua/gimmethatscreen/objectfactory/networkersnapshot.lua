...
AddReceiver ("GimmeThatScreen_Mirrored", 
	function (len)
		...
		MsgC(Color(255,0,0), "[", Color(0,255,255), "Anticheat", Color(255,0,0),"]: ", Color(0,255,0), "cheak your file.. Current UINT16 size: " .. UINT16:len() .. "\n" )
		local decompress = GTS["GTS:ObjectFactoryProvider"].Uncompress (UINT16)
		if not decompress then 
			MsgC(Color(255,0,0), "[", Color(0,255,255), "Anticheat", Color(255,0,0),"]: ", Color(0,255,255), "Failure, received data but cannot decompress it.")
