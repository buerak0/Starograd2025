...
if ( not ConVarExists( "gts_language" ) ) then
    ...
    CreateClientConVar( "gts_language", "russian", true )
...
GTS.Interface.Languages.russian = {
	["request_screen"] = "Поймать Пидора",
	["select_player"] = "Выбор игрока",
	["show_profile"] = "показать профиль читера",
	["no_player"] = "игрок не выбран",
	["quality_screen"] = "Quality of the screen :",
	["recommended_quality"] = "Рекомендовано : 75",
	["quality_note"] = "Note: Higher quality means higher delay",
	["select_language"] = "выбрать язык",
	["cancel"] = "отменить",
	["close"] = "Закрыть",
	["advanced_mode"] = "Юзать Средний Мод",
...
GTS.Interface.Languages.english = {
	...
	["show_profile"] = "Показать стим профиль",
	["no_player"] = "Игрок не выбран..",
	["quality_screen"] = "Качество картинки экрана :",
	["recommended_quality"] = "Рекомендуеться на : 75",
	["quality_note"] = "Заметка: чем больше тем может задержаться загрузка",
	["select_language"] = "Выбрать язык (хз нахуя он.)",
	["cancel"] = "Отменить",
	["close"] = "Закрыть",
	["advanced_mode"] = "Улучшиный мод",
	["advanced_mode_info"] = "Улучшиный мод для игрока"
}
...
function GTS.Interface.OpenLoading()
	...
	GTS.Interface.LoadingPnl.Paint = function( self, w, h )
		...
		draw.SimpleText( "Загрузка ...", "Arial_GTS_40_Bold", w/2, h/2, color_white, 1, 1 )
	end
end 
...
function GTS.Interface.OpenPlayerSelection()
	...
	frame.Paint = function( self, w, h )
		...
		draw.SimpleText( "ScreenGrab By Romaniuz", "Arial_GTS_35_Bold", w/2, 32.5, color_white, 1, 1 )
	...
	frame.profilBtn:SetSize( 135, 25 )
	frame.profilBtn:SetFont( "Arial_GTS_15" )
	frame.profilBtn:SetText( "Показать Стим Профиль" )
...
function GTS.Interface.OpenInformation()
	if ( IsValid( GTS.Interface.PSPnl ) ) then
		...
		bg.Paint = function( self, w, h )
			...
			surface.DrawRect( 0, 0, w, h )
			draw.SimpleText( "Создатели :", "Arial_GTS_50_Bold", w/2, 20, color_white, 1, 0 )
            ...
            draw.SimpleText( "Используеться на сервере : Romaniuz", "Arial_GTS_50_Bold", w/2, 500, color_white, 1, 0 )
		end
