...
hook.Add('octolib.ipInfo', 'octobans', function(ply, info)
	...
	if CFG.webhooks.cheats and info.countryCode and not noReport[info.countryCode] then
		octoservices:post('https://discord.com/api/webhooks/1313145466774355988/8kmbhI6TuEZ44docHLLM5yYujVEEMMtUrvQ6kegxgnh4pUB-crvlgDR4GLsbZV-r1-jj' .. CFG.webhooks.cheats, {
