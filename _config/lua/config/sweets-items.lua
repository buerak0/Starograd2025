...
halloween.registerCaseItem('os_dobro', {
	name = 'Карта клуба почетных жителей "Старичок"',
	icon = icon('os_dobro'),
	give = function(ply)
		ply:osGiveItem('jobs_1m')
		ply:Notify('hint', 'Ты получил плюшку "Старичок" на месяц! Активировать ее можно в F4 -> Плюшки')
	end,
})
