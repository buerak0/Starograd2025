...
local models = octolib.table.mapSequential({
	...
	'models/octo_detective/male_01.mdl',
	'models/octo_detective/male_02.mdl',
	'models/octo_detective/male_03.mdl',
	'models/octo_detective/male_04.mdl',
	'models/octo_detective/male_05.mdl',
	'models/octo_detective/male_06.mdl',
	'models/octo_detective/male_07.mdl',
	'models/octo_detective/male_08.mdl',
	'models/octo_detective/male_09.mdl',
}, function(v, i)
	return {
		name = 'Внешность ' .. i,
		male = true,
...
--carDealer.addVeh('fbi_landstalker', {
	--name = 'Landstalker',
