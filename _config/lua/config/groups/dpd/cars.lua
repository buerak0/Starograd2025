...
carDealer.addCategory('dpd', {
	...
	canUse = function(ply) return ply:Team() == TEAM_DPD, 'Доступно только SPD' end,
	spawns = carDealer.policeSpawns,
	spawnCheck = carDealer.limitedSpawn(12, 'dpd', 'В городе уже много автомобилей SPD, найди напарника или попробуй чуть позже'),
	limitGroup = 'dpd',
})

carDealer.addVeh('spd-vapid', {
	category = 'dpd',
	name = 'SPD Vapid',
...
carDealer.addVeh('spd-buffalo', {
 ...
 carDealer.addVeh('spd-landstalker', {
	category = 'dpd',
	name = 'SPD Landstalker',
	simfphysID = 'sim_fphys_gta4_police3',
	price = 100000,
	deposit = true,
    default = {
        mats = {
            [2] = 'octoteam/models/vehicles/landstalker/police_livery_landstalker',
        },
    },
	police = true,
	canUse = function(ply)
...
local ranks = octolib.array.toKeys {'swat', 'dec1', 'se1', 'se2', 'dec2', 'dec3', 'lie', 'cap', 'cmd', 'asch', 'asc', 'chi', 'gangunit'}
carDealer.addCategory('nomark', {
	...
	spawns = {
        ...
        rp_eastcoast_rbs = carDealer.policeSpawns.rp_eastcoast_v4c,
...
carDealer.addVeh('nomark_emperor', {
	name = 'Emperor',
...
carDealer.addVeh('nomark_esperanto', {
	name = 'Esperanto',
...
carDealer.addVeh('dpd-vapid_ax', {
	category = 'ax',
	name = 'Auxiliary Vapid',
	simfphysID = 'sim_fphys_gta4_police',
	price = 30000,
	deposit = true,
	default = {
		mats = {
			[1] = 'octoteam/models/vehicles/stainer/police_livery_ax',
		},
    },
	police = true,
	radioWhitelist = carDealer.policeRadioStations,
...
local ranks = octolib.array.toKeys {'ax'}
carDealer.addCategory('ax', {
	name = 'Волонтеры',
	icon = 'icon16/user_suit.png',
	ems = true,
--	doNotEvacuate = true,
