...
octoinv.addShopItem('car_fuel', { cat = 'everyday', price = 138 })

-- kits
octoinv.addShopItem('car_kit', { cat = 'car', price = 800 })
octoinv.addShopItem('car_wheel', { cat = 'car', price = 350 })
octoinv.addShopItem('car_paint', { cat = 'car', price = 2200 })
octoinv.addShopItem('tool_susp', { cat = 'car', price = 2000 })
...
octoinv.addShopItem('att1', carAtt(17500, 'spoiler1'))
octoinv.addShopItem('att2', carAtt(19500, 'spoiler2'))
octoinv.addShopItem('att3', carAtt(19000, 'spoiler3'))
octoinv.addShopItem('att4', carAtt(15000, 'spoiler4'))
octoinv.addShopItem('att5', carAtt(20000, 'spoiler5'))
octoinv.addShopItem('att6', carAtt(12000, 'ladder'))
octoinv.addShopItem('att7', carAtt(25000, 'supercharger'))
octoinv.addShopItem('att8', carAtt(12000, 'huladoll'))
