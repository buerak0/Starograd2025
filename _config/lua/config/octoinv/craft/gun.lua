...
octoinv.registerCraft('gun_browning', {
	name = 'Browning',
	desc = L.weapons,
	conts = {'workbench'},
	icon = 'octoteam/icons/weapon_xm1014.png',
	...
	finish = {
		{'weapon', octoinv.gunsItemData.weapon_octo_hz},
	}
})

octoinv.registerCraft('gun_ak74', {
	name = 'AK-74',
	desc = L.weapons,
	conts = {'workbench'},
...
octoinv.registerCraft('gun_ar15', {
	name = 'AR-15',
	desc = L.weapons,
	conts = {'workbench'},
	...
	finish = {
		{'weapon', octoinv.gunsItemData.weapon_octo_ar15},
	}
})
