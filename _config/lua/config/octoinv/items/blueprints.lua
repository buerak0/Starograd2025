...
-- octoinv.registerItem('bp_tv', {
-- 	name = 'Телевизор',
-- 	icon = 'octoteam/icons/blueprint.png',
-- 	mass = 0.1,
-- 	volume = 0.1,
-- 	nostack = true,
-- 	desc = 'Чертеж телевизора',
-- })

-- octoinv.registerItem('bpd_tv', {
-- 	name = 'Телевизор',
-- 	icon = 'octoteam/icons/box3.png',
-- 	mass = 5,
-- 	volume = 5,
-- 	nostack = true,
-- 	desc = 'Позволяющий установить его в своей квартире и смотреть на изображение с камеры',
-- })
